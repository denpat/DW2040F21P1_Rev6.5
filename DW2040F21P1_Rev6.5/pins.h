...
#define X_DIR_PIN 23
#define X_MIN_PIN -1 //22 per la delta sara il salvataggio di emergenza EMERGENCY_STOP
#define X_MAX_PIN 24
#define X_ENABLE_PIN 27

#define Y_STEP_PIN 31
#define Y_DIR_PIN 33
#define Y_MIN_PIN -1 //26 per la delta sara il cambio filo automatico EXT_FILAMENT
#define Y_MAX_PIN 28

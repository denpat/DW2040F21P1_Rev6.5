...
static void lcd_implementation_init()
{
 ...
 //   lcd.createChar(LCD_STR_REFRESH[0], refresh);
    ...
    lcd.createChar(LCD_STR_CROSS[0], cross);
    lcd.clear();
}
...
static void lcd_splash_screen()
{
	...
	lcd.print(" ...RESURRECTING    ");
	lcd.setCursor(0, 1);
	lcd.print("   Wait or Press  ->");
	lcd.setCursor(0, 2);
	lcd.print("        to Abort  ->");
	lcd.setCursor(0, 3);
...
#  else//Heated bed
    ...
    lcd.print(LCD_STR_BEDTEMP[0]);
#  endif
    (int(degBed() + 0.5)<30)?lcd.print("low"):lcd.print(itostr3(tHotend));
    lcd.print('/');
    lcd.print(itostr3left(tTarget));
    lcd_printPGM(PSTR(LCD_STR_DEGREE " "));
    if (tTarget < 10)
...
#  else
    lcd.setCursor(0,1);
    if (!clayMode) {
    	lcd_printPGM(PSTR("FFF mode"));
	} else {
	lcd_printPGM(PSTR("LDM mode"));
	}
    //lcd.print('X');
